...
int activeAreas = 1;
float fadeStep = 100;
unsigned char fadeTarget[3] = {200,200,200};
...
void setup() {
  ...
  areaFadeTargets[0].colour[0] = 255;
  areaFadeTargets[0].colour[1] = 0;
  areaFadeTargets[0].colour[2] = 0;
  areaFadeTargets[1].colour[0] = 0;
  areaFadeTargets[1].colour[1] = 0;
  areaFadeTargets[1].colour[2] = 255;
